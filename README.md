...
To install convos we provide a simple script. All it requires in addition to redis is a working build environment with make and a C compiler. Copy/paste this to the command line:
