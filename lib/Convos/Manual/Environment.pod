...
Set this environment if you want to start Convos as a single process daemon,
with the backend embedded. Example:

  CONVOS_BACKEND_EMBEDDED=1 script/convos daemon --listen http://*:8080
