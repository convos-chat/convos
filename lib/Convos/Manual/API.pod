...
=head3 Resource URL
  ...
  POST http://demo.convos.by/api/connection/{protocol}/{connection_name}/conversations
...
=head3 Resource URL
  ...
  GET http://demo.convos.by/api/connection/{protocol}/{connection_name}/conversation/{conversation_id}/messages
...
=head3 Resource URL
  ...
  DELETE http://demo.convos.by/api/connection/{protocol}/{connection_name}
...
=head3 Resource URL
  ...
  DELETE http://demo.convos.by/api/connection/{protocol}/{connection_name}/conversation/{conversation_id}
...
=head3 Resource URL
  ...
  GET http://demo.convos.by/api/connection/{protocol}/{connection_name}/rooms
...
=head3 Resource URL
  ...
  POST http://demo.convos.by/api/connection/{protocol}/{connection_name}/conversation/{conversation_id}/send
...
=head3 Resource URL
  ...
  POST http://demo.convos.by/api/connection/{protocol}/{connection_name}
