...
=head3 Resource URL
  ...
  POST http://demo.convos.by/api/connection/{connection_id}/dialogues
...
A dialogue.
  ...
  {
    "connection_id": string, // Unique identifier for the connection this dialogue is part of
...
=head3 Resource URL
  ...
  GET http://demo.convos.by/api/dialogues
...
=head3 Resource URL
  ...
  GET http://demo.convos.by/api/connection/{connection_id}/dialogue/{dialogue_id}/messages
...
=head3 Parameters
  ...
  |----------------------------------------------------------------------------------------------|
  | connection_id | path  | string  | Yes      | A unique connection identifier                  |
  | dialogue_id   | path  | string  | Yes      | The name of the person or room                  |
...
=head2 removeDialogue

Remove (part) a dialogue.

=head3 Resource URL

  DELETE http://demo.convos.by/api/connection/{connection_id}/dialogue/{dialogue_id}
...
=head2 sendToDialogue

Send a message to a target.

=head3 Resource URL

  POST http://demo.convos.by/api/connection/{connection_id}/dialogue/{dialogue_id}/send
