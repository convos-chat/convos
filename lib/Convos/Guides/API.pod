...
=head3 Resource URL
  ...
  POST http://demo.convos.by/api/connection/{connection_id}/dialogs
...
Remove (part) a dialog.

=head3 Resource URL

  DELETE http://demo.convos.by/api/connection/{connection_id}/dialog/{dialog_id}
...
=head3 Resource URL
  ...
  POST http://demo.convos.by/api/connection/{connection_id}/dialog/{dialog_id}/send
