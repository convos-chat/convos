...
test('toForm', () => {
  ...
  const url = new ConnectionURL('irc://superwoman:s3cret@irc.example.com:6667/?tls=1&local_address=1.1.1.1&nick=superwoman&realname=Super+Duper&sasl=external&tls_verify=1');
...
test('toSaveOperationParams create', () => {
  ...
  expect(c.toSaveOperationParams({
    ...
    url: 'irc://superwoman:s3cret@irc.example.com:6667/?sasl=none&tls=1&local_address=1.1.1.1&nick=superwoman&realname=Super+Duper&tls_verify=1',
...
test('toSaveOperationParams update', () => {
  ...
  expect(c.toSaveOperationParams({
    ...
    url: 'irc://:s3cret@irc.example.com:6667/?sasl=none&tls=0&nick=superwoman',
    on_connect_commands: [],
