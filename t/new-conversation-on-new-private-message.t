...
{
  $t->get_ok('/chat/conversations')->element_exists('li:nth-of-child(2) a[href="/magnet/%23convos"]')
    ->text_is('li:nth-of-child(3) a[href="/magnet/fooman"] b', 2)->text_is('li a[href="/magnet/fooman"] b' 2)
    ->element_exists('li:nth-of-child(4) a[href="/magnet/batman"]');
}
