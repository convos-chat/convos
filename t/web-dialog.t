...
$t->post_ok('/api/send', json => {connection_id => 'irc-localhost', command => "/join #c"})
...
$t->post_ok('/api/send', json => {connection_id => 'irc-localhost', command => "/join #Convos"})
...
$t->post_ok('/api/send', json => {connection_id => 'irc-localhost', command => "hey!"})
