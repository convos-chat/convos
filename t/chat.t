...
redis_do(
  ...
  [ del => 'user:doe:connection:irc.perl.org:#mojo:msg' ],
);
...

{
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.nicks[data-server="irc.perl.org"][data-target="#convos"]'), 'Got correct 6+#convos';
  is $dom->at('a[href="/irc.perl.org/fooman"][data-nick="fooman"]')->text, 'fooman', 'got fooman';
  is $dom->at('a[href="/irc.perl.org/woman"][data-nick="woman"]')->text, '@woman', 'got woman';
}

{
  # Fix parsing links without a path part
  $connection->add_message({
    params => [ '#mojo', 'http://irc.perl.org is really cool' ],
    prefix => 'fooman!user@host',
  });
  $dom->parse($t->message_ok->message->[1]);
  is eval { $dom->at('a[href="http://irc.perl.org"]')->text }, 'http://irc.perl.org', 'not with "is really cool"' or diag $dom;
...
{
  $connection->add_message({
    params => [ '#mojo', 'doe: see this &amp; link: http://irc.perl.org?a=1&b=2#yikes # really cool' ],
    prefix => 'fooman!user@host',
  });
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.message[data-server="irc.perl.org"][data-target="#mojo"][data-sender="fooman"]'), 'Got correct 6+#mojo';
  is $dom->at('h3 a[href="/irc.perl.org/fooman"]')->text, 'fooman', 'got message from fooman';
  is $dom->at('a[href="http://irc.perl.org?a=1&b=2#yikes"]')->text, 'http://irc.perl.org?a=1&b=2#yikes', 'http://irc.perl.org#yikes';
  is $dom->at('div.content'), '<div class="content whitespace">doe: see this &amp;amp; link: <a href="http://irc.perl.org?a=1&amp;b=2#yikes" target="_blank">http://irc.perl.org?a=1&amp;b=2#yikes</a> # really cool</div>', 'got link and amp';
  ...
  $connection->add_message({
    params => [ '#mojo', 'doe: see this &amp; link: http://irc.perl.org/foo really cool' ],
    prefix => 'fooman!user@host',
  });
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('a[href="http://irc.perl.org/foo"]'), 'link is without really cool' or diag $dom;

  $connection->add_message({
    params => [ '#mojo', 'doe: see this &amp; link: http://irc.perl.org/foo' ],
    prefix => 'fooman!user@host',
  });
  $dom->parse($t->message_ok->message->[1]);
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.action.message[data-server="irc.perl.org"][data-target="#mojo"][data-sender="fooman"]'), 'Got correct 6+#mojo';
  ok $dom->at('a[href="/irc.perl.org/fooman"]'), 'got action message from fooman';
...

{
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.server-message.error[data-server="irc.perl.org"][data-target="any"]'), 'Got IRC error';
...

{
  ...
  ok $dom->at('li.server-message.notice[data-server="irc.perl.org"][data-target="any"]'), 'Got server message';
...

{
  $connection->irc_rpl_whoisuser({
    params => ['', 'doe', 'john', 'irc.perl.org', '', 'Real name'],
  });
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.whois[data-server="irc.perl.org"][data-target="any"]'), 'Got whois';
  is $dom->at('div.content')->all_text, 'doe is john@irc.perl.org (Real name).', 'doe is john@irc.perl.org (Real name)';
}

{
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.whois[data-server="irc.perl.org"][data-target="any"]'), 'Got whois channels';
...

{
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.topic[data-server="irc.perl.org"][data-target="#convos"]'), 'Got no topic';
  is $dom->at('div.content')->all_text, 'No topic is set.', 'No topic is set';

  $connection->irc_topic({ params => ['#convos', 'Awesome'] });
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.topic[data-server="irc.perl.org"][data-target="#convos"]'), 'Got topic';
...

{
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.nick-joined[data-server="irc.perl.org"][data-target="#mojo"]'), 'user joined';
...

{
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.nick-change[data-server="irc.perl.org"][data-target="any"]'), 'nick change';
  is $dom->at('b.old')->text, 'fooman', 'got old nick';
  is $dom->at('a.nick[href="/irc.perl.org/new_nick"]')->text, 'new_nick', 'got new nick';
}

{
  $connection->irc_part({ params => [ '#mojo' ], prefix => 'fooman!user@host' });
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.nick-parted[data-server="irc.perl.org"][data-target="#mojo"]'), 'user parted';
  is $dom->at('div.content')->all_text, 'fooman parted #mojo', 'fooman parted #mojo';

  $connection->irc_part({ params => [ '#mojo' ], prefix => 'doe!user@host' });
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.remove-conversation[data-server="irc.perl.org"][data-target="#mojo"]'), 'self parted';
}

{
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.error[data-server="irc.perl.org"][data-target="any"]'), 'irc.perl.org got banned error';
  is $dom->at('div.content')->all_text, 'Cannot join channel (+b)', 'irc.perl.org - Cannot join channel (+b)';
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.remove-conversation[data-server="irc.perl.org"][data-target="#mojo"]'), 'remove conversation when banned';
}
...

{
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.notice[data-server="irc.perl.org"][data-target="#convos"]'), 'mode to #convos';
...

{
  ...
  $dom->parse($t->message_ok->message->[1]);
  ok $dom->at('li.nick-quit[data-server="irc.perl.org"][data-target="any"]'), 'nick quit';
...
is redis_do('zcard', 'user:doe:connection:irc.perl.org:#mojo:msg'), 11, 'got x messages in database';
