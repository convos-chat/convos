...
$t->get_ok('/api/connection/irc/localhost/dialogue/%23convos/messages')->status_is(200);
is int @{$t->tx->res->json->{messages} || []}, 60, 'got max limit messages';

$t->get_ok('/api/connection/irc/localhost/dialogue/%23convos/messages?limit=1')->status_is(200)
  ...
  ->json_is('/messages/0/sender',  'mr22')->json_is('/messages/0/ts', '2015-06-22T10:23:50')
  ->json_is('/messages/0/type',    'privmsg')->json_is('/messages/1', undef);

$t->get_ok('/api/connection/irc/localhost/dialogue/%23convos/messages?limit=3&match=AppArmor&level=warn')
  ...
  ->json_is('/messages/0/sender',  'jhthorsen')->json_is('/messages/0/ts', '2015-06-21T10:12:25')
  ->json_is('/messages/0/type',    'privmsg')->json_is('/messages/1', undef);
