...
$t->post_ok('/1.0/user/register', form => {email => 'superman', password => 'xyz'})->status_is(400)
...
$t->post_ok('/1.0/user/register', form => {email => 'superman@example.com', password => 's3cret'})->status_is(200)
...
$t->post_ok('/1.0/user', form => {avatar => 'avatar@example.com'})->status_is(200)
