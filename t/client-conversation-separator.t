...
redis_do(
  ...
  [zadd => 'user:doe:conversations', 1392754563, 'magnet:00:23convos'],    # right before 1392754563.9967
);
...
$t->get_ok('/magnet/whoever')->status_is(404);
...
{"network":"magnet","timestamp":1392754563.9967,"target":"#convos","event":"message","highlight":0,"host":"ti0034a400-2938.bb.online.no","user":"~doe","message":"marcus: too tired today. will try to figure out the avatar part another day","nick":"doe","uuid":"70a73b3769a155c66d0b34e75b570cb7"}
