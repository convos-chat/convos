...
redis_do(
  ...
  [ zadd => 'user:doe:conversations', time, 'magnet:00:23convos', time - 1, 'magnet:00batman', time - 2, 'bitlbee:00:26bitlbee' ],
...
$t->get_ok('/chat/conversations')
  ...
  ->element_exists('a[href="/magnet/batman"][data-unread="0"]')
  ->element_exists('li:nth-of-type(2)')
  ->element_exists('a[href="/bitlbee/&bitlbee"][data-unread="0"]')
  ->element_exists('li:nth-of-type(3)')
  ->element_exists('a[href="/magnet/%23convos"][data-unread="0"]')
