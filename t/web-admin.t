...
SKIP: {
    ...
    $t->json_like('/disk_usage/dev',          qr{\w})->json_like('/disk_usage/block_size', qr{\d+})
      ->json_like('/disk_usage/blocks_free',  qr{\d+})
      ->json_like('/disk_usage/blocks_total', qr{\d+})
      ->json_like('/disk_usage/blocks_used',  qr{\d+})
      ->json_like('/disk_usage/inodes_free',  qr{\d+})
      ->json_like('/disk_usage/inodes_total', qr{\d+})
      ->json_like('/disk_usage/inodes_used',  qr{\d+});
  }
};
...
subtest 'change all settings and also reject some' => sub {
...
subtest 'test clearing config' => sub {
...
subtest 'only admins change settings' => sub {
