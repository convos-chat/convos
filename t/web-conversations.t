...
$user->connection(IRC => 'localhost', {})->add_conversation('#private',       sub { });
$user->connection(IRC => 'perl-org',  {})->add_conversation('#oslo.pm',       sub { });
$user->connection(IRC => 'localhost', {})->add_conversation('#Convos s3cret', sub { });
