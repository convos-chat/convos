...
Convos.api.registerUser({body:{invite_code:this.invite_code,email:this.email,password:this.password}},function(err,xhr){if(err)return self.errors=err;self.user.refresh();}.bind(this));}},template:"<div class=\"convos-register\">\n    <div class=\"row not-logged-in-wrapper\">\n      <form @submit.prevent=\"register\" class=\"col s12 m6 offset-m3\">\n        <div class=\"row\">\n          <div class=\"col s12\">\n            <h2>Convos</h2>\n            <p><i>- Collaboration done right.</i></p>\n          </div>\n        </div>\n        <div class=\"row\">\n          <md-input :focus=\"true\" :value.sync=\"email\">Email</md-input>\n        </div>\n        <div class=\"row\">\n          <md-input :value.sync=\"password\" cols=\"s6\" type=\"password\">Password</md-input>\n          <md-input :value.sync=\"passwordAgain\" cols=\"s6\" placeholder=\"Repeat password\" type=\"password\"></md-input>\n        </div>\n        <div class=\"row\" v-if=\"settings.invite_code\">\n          <md-input :value.sync=\"invite_code\" type=\"password\">Invite code</md-input>\n        </div>\n        <div class=\"row\" v-if=\"errors.length\">\n          <div class=\"col s12\"><div class=\"alert\">{{errors[0].message}}</div></div>\n        </div>\n        <div class=\"row\">\n          <div class=\"input-field col s12\">\n            <button class=\"btn waves-effect waves-light\" type=\"submit\">\n              Register <i class=\"material-icons right\">send</i>\n            </button>\n            <a @click.prevent=\"user.currentPage = &#39;convos-login&#39;\" class=\"btn-flat waves-effect waves-light\" href=\"#login\">Log in</a>\n          </div>\n        </div>\n        <div class=\"row\">\n          <div class=\"col s12 about\">\n            © <a href=\"http://nordaaker.com\">{{settings.organization_name}}</a> - <a href=\"http://convos.by\">About</a>\n          </div>\n        </div>\n      </form>\n    </div>\n  </div>\n"})})();