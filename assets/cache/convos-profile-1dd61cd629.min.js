(function(){Vue.component("convos-profile",{props:["user"],data:function(){return{errors:[],password:"",passwordAgain:"",notifications:Notification.permission,sortDialogsByRead:false};},watch:{sortDialogsByRead:function(v,o){this.settings.sortDialogsBy=v?"lastRead":"";}},methods:{save:function(){var self=this;if(this.password!=this.passwordAgain)
