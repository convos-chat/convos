(function(){Vue.component("convos-dialog-settings",{props:["dialog","user"],data:function(){return{markdownOptions:{escape:true,links:true},modes:{'@':'+o','+':'+v'}};},computed:{participants:function(){if(!this.dialog)return[];return Object.keys(this.dialog.participants)
